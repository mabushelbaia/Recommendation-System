...
\begin{itemize}
    ...
    \begin{displayquote}
    "Merlin Models library provides standard models for recommender systems with an aim for high-quality implementations that range from classic machine learning models to highly advanced deep learning models."\footnote{Merlin Models Documentation\cite{MerlinModelsDocs}}
    \end{displayquote}
