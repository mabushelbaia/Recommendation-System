...
Target encoding is a technique used to encode categorical features based on the target variable, where the categorical feature is encoded based on the mean of the target variable for each unique value of the categorical feature. The target encoding technique is used to encode categorical features with high cardinality and to reduce the dimensionality of the categorical features.\cite{TargetEncoding}
